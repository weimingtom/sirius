...
class userAction extends doubanAction {
	public function execute($request) {
		...
		$data  = doubanCacheManager::getInstance()->user_timeline($this->profileId, $this->apiConsumer, $since_id, $before_id, $count, $username);
