...
class WeiboClient 
{
	...
	function friends_timeline($since_id = null, $page = 1, $count = 20, $max_id = null) {
		return $this->home_timeline($since_id, $page, $count, $max_id);
	}
	...
	function comments_by_me( $page = 1, $count = 20) {
		...
		if( $page) $param['page'] = $page;
		if( $count) $param['count'] = $count;
		return $this->get('http://api.t.sina.com.cn/statuses/comments_by_me.json', $param);
	}
	...
	function comments_timeline( $page = 1, $count = 20) {
		...
		if( $page) $param['page'] = $page;
		if( $count) $param['count'] = $count;
		return $this->get('http://api.t.sina.com.cn/statuses/comments_timeline.json', $param);
	}
