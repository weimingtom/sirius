<div>
	<ul>
		...
		<li><a title="微博" href="/sohu/user/?profile_id=<?php echo $profileId?>&name=<?php echo $userData['id']?>&format=html" class="_thread"  expectedWidth="400">微博</a></li>
	</ul>
	<div id="_<?php echo $userData['name']?>_bio" class="_bio userInfo">
        ...
        <span class="icon-28 thread-icon-sohu networklogo">qq</span>
        </span>
		...
		<div class="btns">
			<?php if ($userData['url'] != ""): ?>
	     	...
	     	<?php endif?>
            <a class="btn-spl" href="http://t.sohu.com/u/<?php echo $userData['domain']?>" title="http://t.sohu.com/u/<?php echo $userData['domain']?>" target="_blank">http://t.sohu.com/u/<?php echo $userData['domain']?></a>
	    </div>
